...
// Instanciation d'un nouveau formulaire basé sur $article qui contient déjà les données actuelles de l'article à modifier
    ...
    /**
     * Controleur de la page permettant aux admins de supprimer un commentaire
     *
     * Accès réservé administrateurs du site (ROLE_ADMIN)
     */
    ...
    /**
     * Controleur de la page affichent les resultats des recherches faites par le formulaire de recherche dans la navbar
     */
